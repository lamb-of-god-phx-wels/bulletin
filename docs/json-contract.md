...
Historical `libraryText` and `announcements` blocks remain readable and editable for compatibility, but new documents compose the same results from native paragraphs, lists, images, and reusable page designs.
