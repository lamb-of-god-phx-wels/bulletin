...
if (process.env.BULLETIN_BUILDER_TODOS_ONLY === '1') {
  ...
  await wait(`!document.querySelector('.preview-pane .block-group.layout-stack')`, 'structural undo from focused drag handle');
  ...
  await wait(`Boolean(document.querySelector('.preview-pane .block-group.layout-stack'))`, 'structural redo');
