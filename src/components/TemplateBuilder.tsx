...
export function TemplateBuilder({ template, definitions, onChange, onDefinitionsChange, onSave, onDeleteVersion, onDeleteTemplate, canDeleteVersion, canDeleteTemplate }: {
  template: TemplateV1;
