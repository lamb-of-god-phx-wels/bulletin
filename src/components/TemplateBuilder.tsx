...
export function TemplateBuilder({ template, onChange, onSave }: { template: TemplateV1; onChange(value: TemplateV1): void; onSave(publish: boolean): Promise<void> }) {
